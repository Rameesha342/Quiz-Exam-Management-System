...
public class DeleteQuestion extends javax.swing.JFrame {
    ...
    public void CBFill()
    {
        try
        {
           Class.forName("com.mysql.jdbc.Driver");
            ...
            String qry="select Cat from tbl_q";
            ResultSet rs=st.executeQuery(qry);
            while(rs.next())
            {
                Crs_CB.addItem(rs.getString("Cat"));
            }
        }
        catch(Exception e)
        {
    ...
    private void initComponents() {
        ...
        Btn_Delete.setFont(new java.awt.Font("Algerian", 3, 18)); // NOI18N
       ...
       String ID=Txt_Count.getText();
        try
        {
           Connection Con=Connect.getcon();
            PreparedStatement ps=Con.prepareStatement("Delete from tbl_q where ID=?");
            ps.setString(1, ID);
            ps.executeUpdate();
            JFrame j=new JFrame();
             j.setAlwaysOnTop(true);
             JOptionPane.showMessageDialog(j, "Delete Successfully");
             setVisible(false);
